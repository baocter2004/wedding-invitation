  ...
  return (
    <div className="min-h-screen font-serif antialiased overflow-x-hidden selection:text-black"
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6">
        ...
        {/* ══ HERO ════════════════════════════════════════════ */}
        <section className="relative min-h-screen flex flex-col items-center justify-center text-center py-20 border-x border-b" style={{ borderColor: `${gold}20` }}>
          <div className={`transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-[10px] uppercase tracking-[0.5em] mb-12 opacity-60" style={{ color: gold }}>Trân Trọng Kính Mời</p>
            ...
            <div className="flex items-center justify-center gap-4 mt-8 opacity-80">
              <div className="w-12 h-px" style={{ backgroundColor: `${gold}50` }}></div>
              <p className="text-sm tracking-[0.3em] uppercase">{dt.day} . {dt.month} . {dt.year}</p>
              <div className="w-12 h-px" style={{ backgroundColor: `${gold}50` }}></div>
            </div>
            <p className="text-xs italic mt-3 opacity-50 text-slate-400">{lunar_date_text}</p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <section className="py-16 sm:py-20 text-center border-x" style={{ borderColor: `${gold}20` }}>
            <div className="max-w-2xl mx-auto px-6">
              ...
              <p className="text-lg sm:text-xl leading-loose font-light italic text-slate-300">
                "{intro_text}"
              </p>
            </div>
          </section>
        ...
        <ScrollReveal>
          <section className="py-12 sm:py-16 border-x border-t" style={{ borderColor: `${gold}20` }}>
            ...
            <div className="grid md:grid-cols-2 gap-12 sm:gap-20 px-6 sm:px-12">
              {/* Groom */}
