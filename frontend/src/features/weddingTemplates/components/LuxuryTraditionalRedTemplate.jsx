...
const LuxuryTraditionalRedTemplate = ({ weddingData }) => {
  ...
  return (
    <motion.div
      ...
      className="min-min-h-[85vh] font-serif antialiased selection:bg-red-900 selection:text-white overflow-x-hidden"
    ...
    >
      ...
      {/* ══ HERO SECTION ══════════════════════════════════════ */}
      <section ref={heroRef} className="relative min-h-[85vh] flex flex-col items-center justify-center overflow-hidden bg-[#0A0A0A]">
        ...
        >
          ...
          >
            ...
            <h1 className="text-5xl sm:text-5xl md:text-6xl font-bold tracking-tighter leading-[0.8] mb-10" style={{ fontFamily: '"Playfair Display", serif', color: 'white' }}>
      ...
      <main className="relative z-30 w-full max-w-6xl mx-auto">
        ...
        {/* ══ INTRO QUOTE ═════════════════════════════════════ */}
        <section className="py-12 px-8 text-center bg-white border-b border-slate-50 relative overflow-hidden">
        ...
        {/* ══ LOVE STORY ══════════════════════════════════════ */}
        {love_story && (
          <section className="py-12 px-8 bg-[#FDFCF8]">
            <ScrollReveal variant="blur-reveal">
        ...
        <section className="py-12 px-8 bg-white">
          <div className="max-w-5xl mx-auto">
            <ScrollReveal variant="fade-up">
              <div className="text-center mb-10">
                <h2 className="text-5xl sm:text-5xl font-bold tracking-tighter text-slate-950 mb-6" style={{ fontFamily: '"Playfair Display", serif' }}>Timeline</h2>
        ...
        {bankAccounts.length > 0 && (
          <section className="py-12 px-8 text-center bg-white border-y border-slate-50 relative overflow-hidden">
            ...
            <ScrollReveal variant="blur-reveal">
              ...
              <p className="max-w-2xl mx-auto text-lg sm:text-xl font-light italic text-slate-600 mb-8 leading-relaxed px-6">
          ...
          <ScrollReveal variant="mask-reveal">
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 max-w-5xl mx-auto">
              <div className="w-full lg:w-1/2 text-center lg:text-left">
                ...
                <h2 className="text-6xl sm:text-5xl font-black tracking-tighter text-slate-950 mb-10 leading-[0.85]" style={{ fontFamily: '"Playfair Display", serif' }}>Bạn Sẽ <br /> Đến Chứ?</h2>
        ...
        {/* ══ FOOTER ═══════════════════════════════════════════ */}
        <footer className="py-12 text-center bg-[#0A0A0A] text-white">
          <ScrollReveal variant="blur-reveal">
            <p className="text-[11px] uppercase tracking-[1.2em] font-black mb-12 text-white/30">The Eternal Bond</p>
            <h2 className="text-5xl sm:text-5xl font-black tracking-tighter mb-8" style={{ fontFamily: '"Playfair Display", serif' }}>
            ...
            <p className="mt-12 text-[10px] text-white/20 uppercase tracking-[1.2em] font-black">Powered by iWedding Masterpiece</p>
          </ScrollReveal>
        </footer>
      </main>
    </motion.div>
