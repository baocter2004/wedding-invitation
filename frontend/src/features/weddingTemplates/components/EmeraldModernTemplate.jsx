  ...
  return (
    ...
    >
      ...
      {weddingData?.music_url && (
        ...
        >
          {isPlaying ? (
            ...
            <VolumeX size={20} className="text-slate-400 group-hover:text-emerald-600 transition-colors" />
          )}
        </motion.button>
      )}
      ...
      <section ref={heroRef} className="relative h-screen flex flex-col items-center justify-center overflow-hidden bg-[#0A1A10]">
        ...
        <motion.div
          style={{ y: heroY, opacity: 0.75 }}
          className="absolute inset-0 z-0"
        >
          <img src={cover} alt="" className="w-full h-full object-cover brightness-[0.4]" />
          <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-transparent to-[#0A1A10]" />
        </motion.div>
        ...
        >
          ...
          >
            <div className="mb-10 flex items-center justify-center gap-6">
              ...
              <p className="text-[11px] text-white/80 uppercase tracking-[0.8em] font-black">Modern Editorial</p>
              <div className="h-[1px] w-10 bg-white/30" />
            </div>
            ...
            <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold tracking-tighter leading-[0.8] mb-10" style={{ fontFamily: '"Playfair Display", serif', color: 'white' }}>
              ...
              <span className="flex items-center justify-center gap-8 my-8">
                <div className="h-[1px] flex-1 max-w-[80px] bg-white/20" />
            ...
            <div className="mt-16 flex flex-wrap justify-center items-center gap-10 sm:gap-16">
      ...
      <main className="relative z-30 w-full max-w-6xl mx-auto">
        ...
        {/* ══ INTRO ═══════════════════════════════════════════ */}
        <section className="py-24 px-8 text-center bg-white border-b border-slate-50">
          <ScrollReveal variant="blur-reveal">
            <div className="max-w-4xl mx-auto">
              <Leaf size={28} className="mx-auto mb-10 opacity-30 text-emerald-900" />
              <p className="text-2xl sm:text-4xl leading-[1.3] font-light italic text-slate-950" style={{ fontFamily: '"Playfair Display", serif' }}>
                "{intro_text}"
              </p>
              <div className="mt-12 h-[1px] w-20 mx-auto bg-slate-200" />
            </div>
          </ScrollReveal>
        </section>
        ...
        <section className="py-20 px-8 bg-white">
          <ScrollReveal variant="mask-reveal">
            <div className="max-w-5xl mx-auto aspect-[16/9] rounded-[2rem] overflow-hidden shadow-2xl relative group">
              <img src={cover} alt="Wedding" className="w-full h-full object-cover transition-transform duration-[4s] group-hover:scale-105" />
              <div className="absolute inset-0 bg-emerald-950/5 transition-opacity group-hover:opacity-0" />
            </div>
          </ScrollReveal>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            <ScrollReveal variant="fade-up">
              <div className="text-center mb-20">
                <span className="text-[11px] uppercase tracking-[0.8em] font-black text-emerald-900/40 mb-4 block">The Legacy</span>
            ...
            <div className="grid md:grid-cols-2 gap-12 sm:gap-24 max-w-5xl mx-auto">
              ...
              <ScrollReveal variant="mask-reveal">
                <div className="flex flex-col items-center text-center group">
                  <div className="relative w-64 h-80 mb-10 overflow-hidden rounded-[2rem] shadow-xl transition-all duration-700 group-hover:scale-[1.01] bg-white border-[10px] border-emerald-50">
                  ...
                  <h3 className="text-4xl font-bold tracking-tighter text-emerald-950" style={{ fontFamily: '"Playfair Display", serif' }}>{groom_full_name}</h3>
                  <span className="text-[11px] uppercase tracking-[0.5em] font-black text-emerald-900/30 mt-3 block">The Groom</span>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal variant="mask-reveal" delay={0.2}>
                <div className="flex flex-col items-center text-center group">
                  ...
                  <div className="h-[1px] w-10 bg-slate-200 mb-6" />
                  <h3 className="text-4xl font-bold tracking-tighter text-emerald-950" style={{ fontFamily: '"Playfair Display", serif' }}>{bride_full_name}</h3>
                  <span className="text-[11px] uppercase tracking-[0.5em] font-black text-emerald-900/30 mt-3 block">The Bride</span>
                </div>
              </ScrollReveal>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <ScrollReveal variant="fade-up">
              <div className="text-center mb-20">
                ...
                <p className="text-[11px] font-black tracking-[0.8em] uppercase text-emerald-900/40">{lunar_date_text}</p>
              </div>
            </ScrollReveal>
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
              {events.map((event, idx) => (
                <ScrollReveal key={event.id} delay={idx * 0.2} variant="mask-reveal">
                  <div className="group relative bg-white rounded-[3rem] p-8 sm:p-12 shadow-[0_10px_40px_rgba(0,0,0,0.02)] border border-slate-50 hover:shadow-[0_60px_120px_-20px_rgba(6,95,70,0.12)] transition-all duration-700 overflow-hidden text-center flex flex-col items-center">
                    <div className="w-20 h-20 rounded-full bg-emerald-50 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform shadow-inner">
                      {event.event_type === 'ceremony' ? <Calendar size={28} className="text-emerald-900 opacity-40" /> : <Sparkles size={28} className="text-emerald-900 opacity-40" />}
                    </div>
                    ...
                    <div className="space-y-10 mb-12 w-full">
                      <div className="flex flex-col items-center">
                        <Clock size={20} className="mb-4 text-emerald-700/50" />
                      ...
                      <div className="flex flex-col items-center">
                        <MapPin size={20} className="mb-4 text-emerald-700/50" />
                        ...
                        {event.note && (
                          <div className="mt-6 p-5 rounded-[1.5rem] bg-emerald-50 italic text-xs text-emerald-900/70 border border-emerald-900/10">
                            {event.note}
                          </div>
                        )}
                      </div>
        ...
        <section className="py-24 px-6 bg-white">
          <ScrollReveal variant="fade-up">
            <div className="text-center mb-20">
              <span className="text-[11px] uppercase tracking-[0.8em] font-black text-emerald-900/30 mb-4 block">Visual Journey</span>
            ...
            {gallery.map((photo, i) => (
              <ScrollReveal key={photo.id} delay={(i % 4) * 0.1} variant="scale-up">
                <div className="break-inside-avoid rounded-[2.5rem] overflow-hidden shadow-lg group relative border border-slate-50 p-2 bg-white">
                  ...
                  <div className="absolute inset-0 bg-emerald-950/80 opacity-0 group-hover:opacity-100 transition-opacity duration-700 flex items-center justify-center p-8 text-center backdrop-blur-[2px]">
                    <p className="text-[10px] uppercase tracking-[0.5em] font-black text-white border-b border-white/30 pb-4">{photo.caption || 'Special Memory'}</p>
                  </div>
                </div>
              </ScrollReveal>
            ))}
        ...
        {bankAccounts.length > 0 && (
          <section className="py-24 px-8 text-center bg-[#FDFCF8] border-y border-slate-50 relative overflow-hidden">
            <ScrollReveal variant="blur-reveal">
              <h2 className="text-[11px] font-black uppercase tracking-[0.8em] text-emerald-900/40 mb-10">Gratitude</h2>
          ...
          <ScrollReveal variant="mask-reveal">
            <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 max-w-5xl mx-auto">
              <div className="w-full lg:w-1/2 text-center lg:text-left">
                <span className="text-[11px] uppercase tracking-[0.8em] font-black text-emerald-900/30 mb-6 block">R.S.V.P</span>
                ...
                <div className="flex items-center justify-center lg:justify-start gap-8 opacity-40">
                  <div className="w-16 h-16 rounded-full border border-emerald-900/40 flex items-center justify-center">
                    <Heart size={24} className="text-emerald-900" />
                  </div>
                  <span className="text-[11px] uppercase tracking-[0.5em] font-black text-slate-950">Awaiting your response</span>
                </div>
              </div>

              <div className="w-full lg:w-1/2 bg-white p-8 sm:p-14 rounded-[3rem] shadow-[0_60px_120px_-20px_rgba(6,95,70,0.12)] border border-slate-100">
                <form className="space-y-10">
                  <div className="group relative">
                    <label className="block text-[11px] uppercase tracking-[0.4em] mb-4 text-slate-500 group-focus-within:text-emerald-900 transition-all font-bold">Họ và Tên</label>
                  ...
                  <div className="group relative">
                    <label className="block text-[11px] uppercase tracking-[0.4em] mb-4 text-slate-500 group-focus-within:text-emerald-900 transition-all font-bold">Xác Nhận</label>
                    <div className="relative">
        ...
        {/* ══ FOOTER ═══════════════════════════════════════════ */}
        <footer className="py-24 text-center border-t border-slate-50 bg-[#0A1A10] text-white">
          <ScrollReveal variant="blur-reveal">
            <p className="text-[11px] uppercase tracking-[1.2em] font-black mb-12 text-white/30">Forever Together</p>
            <h2 className="text-5xl sm:text-7xl font-black tracking-tighter mb-16" style={{ fontFamily: '"Playfair Display", serif' }}>
              {groom_name} <span className="text-emerald-500/30 italic font-light mx-4">&</span> {bride_name}
            </h2>
            ...
            <p className="mt-24 text-[10px] text-white/20 uppercase tracking-[1.2em] font-black">Powered by iWedding Emerald Collection</p>
          </ScrollReveal>
        </footer>
      </main>
    </motion.div>
