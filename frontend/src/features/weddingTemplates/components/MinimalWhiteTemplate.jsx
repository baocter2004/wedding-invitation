  ...
  return (
    ...
    >
      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-20 px-6 overflow-hidden">
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm sm:max-w-md aspect-[3/4] mb-16 p-4 bg-white shadow-[0_40px_80px_-15px_rgba(0,0,0,0.1)] rounded-sm border border-slate-100"
          >
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-7xl md:text-8xl font-bold tracking-tighter leading-[0.8] text-center text-slate-900"
      ...
      <main className="relative z-10 w-full max-w-6xl mx-auto px-6 sm:px-12">
        ...
        {/* ══ LOVE STORY ══════════════════════════════════════ */}
        {love_story && (
          <section className="py-24 px-8 bg-slate-50 rounded-[2rem] my-24 border border-slate-100">
            <ScrollReveal variant="blur-reveal">
        ...
        {bankAccounts.length > 0 && (
          <section className="py-24 px-8 text-center bg-slate-950 text-white rounded-[3rem] my-24 shadow-2xl relative overflow-hidden">
            ...
            <ScrollReveal variant="blur-reveal">
              ...
              <p className="max-w-2xl mx-auto text-lg sm:text-xl font-light italic text-slate-400 mb-16 leading-relaxed">
          ...
          <ScrollReveal variant="mask-reveal">
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
              <div className="w-full lg:w-1/2 text-center lg:text-left">
                ...
                <h2 className="text-6xl sm:text-7xl font-bold tracking-tighter mb-10 leading-[0.85]" style={{ fontFamily: '"Playfair Display", serif' }}>Bạn Sẽ <br /> Đến Chứ?</h2>
        ...
        <footer className="py-24 text-center relative overflow-hidden border-t border-slate-100">
          <ScrollReveal variant="blur-reveal">
            ...
            <h2 className="text-5xl sm:text-7xl font-bold tracking-tighter text-slate-950 mb-16" style={{ fontFamily: '"Playfair Display", serif' }}>
            ...
            <p className="mt-24 text-[10px] text-slate-500 opacity-60 uppercase tracking-[1em] font-black">Powered by iWedding Minimal Collection</p>
          </ScrollReveal>
        </footer>
      </main>
    </motion.div>
