  ...
  return (
    ...
    >
      ...
      {weddingData?.music_url && (
        ...
        >
          {isPlaying ? (
            ...
            <VolumeX size={20} className="text-slate-400 group-hover:text-slate-900 transition-colors" />
          )}
        </motion.button>
      )}
      ...
      <section ref={heroRef} className="relative min-min-h-[85vh] flex flex-col items-center justify-center pt-24 pb-20 px-6 overflow-hidden">
        ...
        >
          <motion.p
            ...
            className="text-[11px] uppercase tracking-[1em] font-black text-slate-500 mb-10"
          >
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm sm:max-w-md aspect-[3/4] mb-8 p-4 bg-white shadow-[0_40px_80px_-15px_rgba(0,0,0,0.1)] rounded-sm border border-slate-100"
          >
            ...
            {/* Elegant Framing */}
            <div className="absolute -top-4 -left-4 w-16 h-16 border-t border-l border-slate-300" />
            <div className="absolute -bottom-4 -right-4 w-16 h-16 border-b border-r border-slate-300" />
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-5xl md:text-6xl font-bold tracking-tighter leading-[0.8] text-center text-slate-900"
            style={{ fontFamily: '"Playfair Display", serif' }}
          >
            <span className="block">{groom_name}</span>
            <span className="flex items-center justify-center gap-8 my-8">
              <div className="h-[1px] flex-1 max-w-[100px] bg-slate-200" />
              <span className="text-2xl italic font-light text-slate-300">&</span>
              <div className="h-[1px] flex-1 max-w-[100px] bg-slate-200" />
            </span>
          ...
          <div className="mt-16 flex flex-col items-center gap-8">
            <div className="flex items-center gap-10">
              <div className="flex flex-col items-center">
                <span className="text-5xl sm:text-6xl font-light tracking-tighter text-slate-800">{dt.day}</span>
                <span className="text-[11px] uppercase tracking-widest font-black text-slate-500 mt-2">Day</span>
              </div>
              <div className="h-10 w-[1px] bg-slate-200" />
              <div className="flex flex-col items-center">
                <span className="text-5xl sm:text-6xl font-light tracking-tighter text-slate-800">{dt.month}</span>
                <span className="text-[11px] uppercase tracking-widest font-black text-slate-500 mt-2">Month</span>
              </div>
              <div className="h-10 w-[1px] bg-slate-200" />
              <div className="flex flex-col items-center">
                <span className="text-5xl sm:text-6xl font-light tracking-tighter text-slate-800">{dt.year}</span>
                <span className="text-[11px] uppercase tracking-widest font-black text-slate-500 mt-2">Year</span>
              </div>
            </div>
            <p className="text-xs italic font-medium tracking-[0.3em] text-slate-500 uppercase">{lunar_date_text}</p>
            <div className="pt-10">
        ...
        >
          <div className="w-[1px] h-16 bg-gradient-to-b from-slate-950 to-transparent" />
        </motion.div>
      </section>
      ...
      <main className="relative z-10 w-full max-w-6xl mx-auto px-6 sm:px-12">
        ...
        <section className="py-12 text-center relative overflow-hidden">
          <ScrollReveal variant="blur-reveal">
            <div className="max-w-4xl mx-auto px-6">
              <Sparkles size={28} className="mx-auto mb-10 text-slate-400" />
              <p className="text-2xl sm:text-4xl leading-[1.3] font-light italic text-slate-800" style={{ fontFamily: '"Playfair Display", serif' }}>
                "{intro_text}"
              </p>
              <div className="mt-12 w-20 h-[1px] mx-auto bg-slate-900/10" />
            </div>
          </ScrollReveal>
        </section>
        ...
        <section className="py-12 px-6">
          <ScrollReveal variant="fade-up">
            <div className="text-center mb-10">
              <span className="text-[11px] uppercase tracking-[0.8em] font-black text-slate-500 mb-6 block">Grand Heritage</span>
              <div className="h-[1px] w-20 mx-auto bg-slate-200" />
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-2 gap-12 sm:gap-12 max-w-5xl mx-auto">
            ...
            <ScrollReveal variant="mask-reveal">
              <div className="flex flex-col items-center text-center group">
                <div className="relative w-64 h-80 mb-10 rounded-[2rem] overflow-hidden shadow-xl transition-all duration-700 group-hover:scale-[1.01] border border-slate-50 bg-white p-3 shadow-slate-100/50">
                ...
                <span className="text-[11px] uppercase tracking-[0.4em] font-black text-slate-500 mt-3 block">The Groom</span>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal variant="mask-reveal" delay={0.2}>
              <div className="flex flex-col items-center text-center group">
                ...
                <div className="h-[1px] w-10 bg-slate-200 mb-6" />
                <h3 className="text-4xl font-bold tracking-tighter text-slate-900" style={{ fontFamily: '"Playfair Display", serif' }}>{bride_full_name}</h3>
                <span className="text-[11px] uppercase tracking-[0.4em] font-black text-slate-500 mt-3 block">The Bride</span>
              </div>
            </ScrollReveal>
          </div>
        </section>
        ...
        {/* ══ LOVE STORY ══════════════════════════════════════ */}
        {love_story && (
          <section className="py-12 px-8 bg-slate-50 rounded-[2rem] my-12 border border-slate-100">
            <ScrollReveal variant="blur-reveal">
              <div className="max-w-4xl mx-auto text-center">
                <span className="text-[11px] uppercase tracking-[0.8em] font-black text-slate-500 mb-8 block">Our Sacred Story</span>
                <h2 className="text-5xl sm:text-6xl font-bold tracking-tighter mb-12 text-slate-950" style={{ fontFamily: '"Playfair Display", serif' }}>Hành Trình Hạnh Phúc</h2>
                ...
                <div className="mt-16 flex justify-center opacity-20">
                  <Heart size={48} fill="currentColor" className="text-slate-900" />
                </div>
              </div>
            </ScrollReveal>
          </section>
        ...
        <section className="py-12 px-6">
          <ScrollReveal variant="fade-up">
            <div className="text-center mb-10">
              <h2 className="text-5xl sm:text-5xl font-bold tracking-tighter mb-6 text-slate-950" style={{ fontFamily: '"Playfair Display", serif' }}>Timeline</h2>
              <div className="flex items-center justify-center gap-6">
                <div className="h-[1px] w-12 bg-slate-200" />
                <p className="text-[11px] font-black tracking-[0.5em] uppercase text-slate-500">{lunar_date_text}</p>
                <div className="h-[1px] w-12 bg-slate-200" />
              </div>
            </div>
          </ScrollReveal>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 max-w-5xl mx-auto">
            {events.map((event, idx) => (
              <ScrollReveal key={event.id} delay={idx * 0.2} variant="mask-reveal">
                <div className="group relative p-8 sm:p-14 rounded-[3rem] border border-slate-100 bg-white hover:shadow-[0_40px_80px_-15px_rgba(0,0,0,0.06)] transition-all duration-700 overflow-hidden text-center flex flex-col items-center shadow-sm">
                  <div className="w-20 h-20 rounded-full bg-slate-50 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform shadow-inner">
                    {event.event_type === 'ceremony' ? <Heart size={28} className="text-slate-950 opacity-40" /> : <Sparkles size={28} className="text-slate-950 opacity-40" />}
                  </div>
                  ...
                  <div className="space-y-10 mb-12 w-full">
                    ...
                    <div className="flex flex-col items-center">
                      <MapPin size={20} className="text-slate-400 mb-4" />
                      <p className="text-xl font-bold text-slate-900 mb-1">{event.venue_name}</p>
                      <p className="text-sm leading-relaxed max-w-sm mx-auto text-slate-600">{event.address}</p>
                      {event.note && (
                        <div className="mt-6 p-5 rounded-[1.5rem] bg-slate-50 italic text-xs text-slate-600 border border-slate-100">
                          {event.note}
                        </div>
                      )}
                    </div>
                  ...
                  <motion.a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-full sm:w-auto min-w-[180px] py-5 px-10 rounded-full bg-slate-950 text-white font-black uppercase tracking-[0.3em] text-[10px] transition-all shadow-lg hover:bg-black active:scale-95"
                  >
        ...
        <section className="py-12">
          <ScrollReveal variant="fade-up">
            <div className="text-center mb-10 px-6">
              <span className="text-[11px] uppercase tracking-[0.8em] font-black text-slate-500 mb-6 block">Treasured Anthology</span>
          ...
          <div className="columns-1 sm:columns-2 lg:columns-4 gap-6 space-y-6 max-w-[1400px] mx-auto px-4">
            {gallery.map((photo, i) => (
              <ScrollReveal key={photo.id} delay={(i % 4) * 0.1} variant="scale-up">
                <div className="break-inside-avoid rounded-[2rem] overflow-hidden shadow-lg group relative border border-slate-50 bg-white p-2">
                  ...
                  <div className="absolute inset-0 bg-white/90 opacity-0 group-hover:opacity-100 transition-opacity duration-700 flex items-center justify-center p-8 text-center backdrop-blur-[2px]">
                    <p className="text-[10px] uppercase tracking-[0.4em] font-black text-slate-900 border-b border-slate-200 pb-4">{photo.caption || 'Pure Moment'}</p>
                  </div>
                </div>
              </ScrollReveal>
            ))}
        ...
        {bankAccounts.length > 0 && (
          <section className="py-12 px-8 text-center bg-slate-950 text-white rounded-[3rem] my-12 shadow-2xl relative overflow-hidden">
            ...
            <ScrollReveal variant="blur-reveal">
              <h2 className="text-[11px] font-black uppercase tracking-[1em] text-slate-600 mb-10">Registry</h2>
              <h3 className="text-4xl sm:text-6xl font-bold mb-12 tracking-tighter" style={{ fontFamily: '"Playfair Display", serif' }}>Hộp Mừng Cưới</h3>
              <p className="max-w-2xl mx-auto text-lg sm:text-xl font-light italic text-slate-400 mb-8 leading-relaxed">
          ...
          <ScrollReveal variant="mask-reveal">
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
              <div className="w-full lg:w-1/2 text-center lg:text-left">
                <span className="text-[11px] uppercase tracking-[0.8em] font-black text-slate-500 mb-8 block">R.S.V.P</span>
                <h2 className="text-6xl sm:text-5xl font-bold tracking-tighter mb-10 leading-[0.85]" style={{ fontFamily: '"Playfair Display", serif' }}>Bạn Sẽ <br /> Đến Chứ?</h2>
                ...
                <div className="flex items-center justify-center lg:justify-start gap-8 opacity-40">
                  <div className="w-16 h-16 rounded-full border border-slate-900 flex items-center justify-center">
                    <Heart size={20} className="text-slate-950" />
                  </div>
                  <span className="text-[11px] uppercase tracking-[0.5em] font-black text-slate-950">Awaiting your response</span>
                </div>
              </div>

              <div className="w-full lg:w-1/2 bg-white p-8 sm:p-14 border border-slate-100 rounded-[3rem] shadow-[0_40px_80px_-15px_rgba(0,0,0,0.08)]">
                <form className="space-y-10">
                  <div className="group relative">
                    <label className="block text-[11px] uppercase tracking-[0.4em] mb-4 text-slate-500 group-focus-within:text-slate-950 transition-all font-bold">Họ và Tên</label>
                  ...
                  <div className="group relative">
                    <label className="block text-[11px] uppercase tracking-[0.4em] mb-4 text-slate-500 group-focus-within:text-slate-950 transition-all font-bold">Sẽ Tham Dự?</label>
                    <div className="relative">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="button"
                    className="w-full py-7 bg-slate-950 text-white font-black transition-all shadow-xl flex items-center justify-center gap-5 uppercase tracking-[0.5em] text-[10px] rounded-full"
                  >
        ...
        <footer className="py-12 text-center relative overflow-hidden border-t border-slate-100">
          <ScrollReveal variant="blur-reveal">
            <p className="text-[11px] uppercase tracking-[1.2em] font-black mb-10 text-slate-500">Endless Love</p>
            <h2 className="text-5xl sm:text-5xl font-bold tracking-tighter text-slate-950 mb-8" style={{ fontFamily: '"Playfair Display", serif' }}>
              {groom_name} <span className="text-slate-200 italic font-light mx-4">&</span> {bride_name}
            </h2>
            <div className="flex items-center justify-center gap-8 opacity-20">
              <div className="h-[1px] w-16 bg-slate-950" />
              <Heart size={20} fill="currentColor" className="text-slate-900" />
              <div className="h-[1px] w-16 bg-slate-950" />
            </div>
            <p className="mt-12 text-[10px] text-slate-500 opacity-60 uppercase tracking-[1em] font-black">Powered by iWedding Minimal Collection</p>
          </ScrollReveal>
        </footer>
      </main>
    </motion.div>
