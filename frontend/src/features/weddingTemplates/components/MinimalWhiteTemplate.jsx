  ...
  return (
    ...
    >
      ...
      <section ref={heroRef} className="relative min-min-h-[85vh] flex flex-col items-center justify-center pt-24 pb-20 px-6 overflow-hidden">
        ...
        >
          <motion.p
            ...
            className="text-xs uppercase tracking-[0.8em] font-black text-slate-500 mb-10"
          >
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm sm:max-w-md aspect-[3/4] mb-8 p-4 bg-white shadow-2xl rounded-sm border border-slate-100"
          >
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl font-bold tracking-tighter leading-none text-center text-slate-900"
          ...
          <div className="mt-16 flex flex-col items-center gap-8">
            <div className="flex items-center gap-10">
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs uppercase tracking-widest font-black text-slate-500 mt-2">Day</span>
              </div>
              <div className="h-10 w-px bg-slate-200" />
              <div className="flex flex-col items-center">
                <span className="text-5xl sm:text-6xl font-light tracking-tighter text-slate-800">{dt.month}</span>
                <span className="text-xs uppercase tracking-widest font-black text-slate-500 mt-2">Month</span>
              </div>
              <div className="h-10 w-px bg-slate-200" />
              <div className="flex flex-col items-center">
                <span className="text-5xl sm:text-6xl font-light tracking-tighter text-slate-800">{dt.year}</span>
                <span className="text-xs uppercase tracking-widest font-black text-slate-500 mt-2">Year</span>
              </div>
            </div>
            <p className="text-xs italic font-medium tracking-widest text-slate-500 uppercase">{lunar_date_text}</p>
            <div className="pt-10">
        ...
        >
          <div className="w-px h-16 bg-gradient-to-b from-slate-950 to-transparent" />
        </motion.div>
      </section>
      ...
      <main className="relative z-10 w-full max-w-6xl mx-auto px-6 sm:px-12">
        ...
        <section className="py-12 text-center relative overflow-hidden">
          <ScrollReveal variant="blur-reveal">
            <div className="max-w-4xl mx-auto px-6">
              ...
              <p className="text-2xl sm:text-4xl leading-tight font-light italic text-slate-800" style={{ fontFamily: '"Playfair Display", serif' }}>
                "{intro_text}"
              </p>
              <div className="mt-12 w-20 h-px mx-auto bg-slate-900/10" />
            </div>
          </ScrollReveal>
        </section>
        ...
        <section className="py-12 px-6">
          <ScrollReveal variant="fade-up">
            <div className="text-center mb-10">
              <span className="text-xs uppercase tracking-[0.8em] font-black text-slate-500 mb-6 block">Grand Heritage</span>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
              ...
              <div className="flex flex-col items-center text-center group">
                ...
                <div className="space-y-8 mb-10">
                  <div className="flex flex-col">
                    <span className="text-xs uppercase tracking-widest text-slate-500 mb-2 font-bold">Thân phụ</span>
                    <span className="text-2xl font-bold text-slate-900 tracking-tight">{groom_father_name}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-xs uppercase tracking-widest text-slate-500 mb-2 font-bold">Thân mẫu</span>
                    <span className="text-2xl font-bold text-slate-900 tracking-tight">{groom_mother_name}</span>
                  </div>
                </div>

                <div className="h-px w-10 bg-slate-200 mb-6" />
                ...
                <span className="text-xs uppercase tracking-widest font-black text-slate-500 mt-3 block">The Groom</span>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal variant="mask-reveal" delay={0.2}>
              <div className="flex flex-col items-center text-center group">
                ...
                <span className="text-xs uppercase tracking-widest font-black text-slate-500 mt-3 block">The Bride</span>
              </div>
            </ScrollReveal>
          </div>
        </section>
        ...
        {/* ══ LOVE STORY ══════════════════════════════════════ */}
        {love_story && (
          <section className="py-12 px-8 bg-slate-50 rounded-3xl my-12 border border-slate-100">
            <ScrollReveal variant="blur-reveal">
              <div className="max-w-4xl mx-auto text-center">
                <span className="text-xs uppercase tracking-[0.8em] font-black text-slate-500 mb-8 block">Our Sacred Story</span>
        ...
        <section className="py-12 px-6">
          <ScrollReveal variant="fade-up">
            <div className="text-center mb-10">
              <h2 className="text-4xl sm:text-5xl font-bold tracking-tighter mb-6 text-slate-950" style={{ fontFamily: '"Playfair Display", serif' }}>Timeline</h2>
              <div className="flex items-center justify-center gap-6">
                <div className="h-px w-12 bg-slate-200" />
                <p className="text-xs font-black tracking-widest uppercase text-slate-500">{lunar_date_text}</p>
                <div className="h-px w-12 bg-slate-200" />
              </div>
            </div>
          </ScrollReveal>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {events.map((event, idx) => (
              <ScrollReveal key={event.id} delay={idx * 0.2} variant="mask-reveal">
                <div className="group relative p-8 sm:p-14 rounded-3xl border border-slate-100 bg-white hover:shadow-2xl transition-all duration-700 overflow-hidden text-center flex flex-col items-center shadow-sm">
                  <div className="w-20 h-20 rounded-full bg-slate-50 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                  ...
                  <div className="space-y-10 mb-12 w-full">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      {event.note && (
                        <div className="mt-6 p-5 rounded-2xl bg-slate-50 italic text-xs text-slate-600 border border-slate-100">
                          {event.note}
                        </div>
                      )}
                    </div>
                  ...
                  <motion.a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-full sm:w-auto min-w-[180px] py-4 px-10 rounded-full bg-slate-950 text-white font-black uppercase tracking-widest text-xs transition-all shadow-lg hover:bg-black"
                  >
        ...
        <section className="py-12">
          <ScrollReveal variant="fade-up">
            <div className="text-center mb-10 px-6">
              <span className="text-xs uppercase tracking-[0.8em] font-black text-slate-500 mb-6 block">Treasured Anthology</span>
              <h2 className="text-4xl sm:text-5xl font-bold tracking-tighter text-slate-950" style={{ fontFamily: '"Playfair Display", serif' }}>Gallery</h2>
            </div>
          </ScrollReveal>
          ...
          <div className="columns-1 sm:columns-2 lg:columns-4 gap-6 space-y-6 max-w-[1400px] mx-auto px-4">
            {gallery.map((photo, i) => (
              <ScrollReveal key={photo.id} delay={(i % 4) * 0.1} variant="scale-up">
                <div className="break-inside-avoid rounded-3xl overflow-hidden shadow-lg group relative border border-slate-50 bg-white p-2">
                  ...
                  <div className="absolute inset-0 bg-white/90 opacity-0 group-hover:opacity-100 transition-opacity duration-700 flex items-center justify-center p-8 text-center backdrop-blur-sm">
                    <p className="text-xs uppercase tracking-widest font-black text-slate-900 border-b border-slate-200 pb-4">{photo.caption || 'Pure Moment'}</p>
                  </div>
                </div>
              </ScrollReveal>
            ))}
        ...
        {bankAccounts.length > 0 && (
          <section className="py-12 px-8 text-center bg-slate-950 text-white rounded-3xl my-12 shadow-2xl relative overflow-hidden">
            <ScrollReveal variant="blur-reveal">
              <h2 className="text-xs font-black uppercase tracking-[1em] text-slate-600 mb-10">Registry</h2>
          ...
          <ScrollReveal variant="mask-reveal">
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
              <div className="w-full lg:w-1/2 text-center lg:text-left">
                <span className="text-xs uppercase tracking-[0.8em] font-black text-slate-500 mb-8 block">R.S.V.P</span>
                <h2 className="text-5xl sm:text-6xl font-bold tracking-tighter mb-10 leading-none" style={{ fontFamily: '"Playfair Display", serif' }}>Bạn Sẽ <br /> Đến Chứ?</h2>
              ...
              <div className="w-full lg:w-1/2 bg-white p-8 sm:p-14 border border-slate-100 rounded-3xl shadow-2xl">
                <form className="space-y-10">
                  <div className="group relative">
                    <label className="block text-xs uppercase tracking-widest mb-4 text-slate-500 group-focus-within:text-slate-950 transition-all font-bold">Họ và Tên</label>
                  ...
                  <div className="group relative">
                    <label className="block text-xs uppercase tracking-widest mb-4 text-slate-500 group-focus-within:text-slate-950 transition-all font-bold">Sẽ Tham Dự?</label>
                    <div className="relative">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="button"
                    className="w-full py-6 bg-slate-950 text-white font-black transition-all shadow-xl flex items-center justify-center gap-5 uppercase tracking-widest text-xs rounded-full"
                  >
        ...
        <footer className="py-12 text-center relative overflow-hidden border-t border-slate-100">
          <ScrollReveal variant="blur-reveal">
            <p className="text-xs uppercase tracking-[1.2em] font-black mb-10 text-slate-500">Endless Love</p>
            <h2 className="text-4xl sm:text-5xl font-bold tracking-tighter text-slate-950 mb-8" style={{ fontFamily: '"Playfair Display", serif' }}>
            ...
            <div className="flex items-center justify-center gap-8 opacity-20">
              <div className="h-px w-16 bg-slate-950" />
              <Heart size={20} fill="currentColor" className="text-slate-900" />
              <div className="h-px w-16 bg-slate-950" />
            </div>
            <p className="mt-12 text-xs text-slate-500 opacity-60 uppercase tracking-widest font-black">Powered by iWedding Minimal Collection</p>
          </ScrollReveal>
        </footer>
      </main>
    </motion.div>
